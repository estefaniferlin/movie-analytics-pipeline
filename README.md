...
│       ├── genres\_and\_users\_dashboard.png

│       └── movies\_dashboard.png
...
> - `<BUCKET\_NAME>` → The name of your Google Cloud Storage bucket where the CSV files are stored.
...
&#x20;  1. `sql/raw/create\_raw\_tables.sql`

&#x20;  2. `sql/analytics/create\_analytics\_tables.sql`

&#x20;  3. `sql/views/create\_views.sql`
...
The complete demonstration is available \[here](demo/dashboard\_demo.mp4).
...
!\[Top Movies](images/dashboards/movies\_dashboard.png)
...
!\[Genre Performance and User Activity](images/dashboards/genre\_and\_users\_dashboard.png)
...
💻 \[GitHub](https://github.com/SEU\_USUARIO)
